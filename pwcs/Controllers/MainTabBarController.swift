...
class MainTabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        agendaVC.tabBarItem = UITabBarItem(title: "Agenda", image: UIImage.init(icon: .icofont(.calendar), size: CGSize(width: 30, height: 30)), selectedImage: UIImage.init(icon: .icofont(.calendar), size: CGSize(width: 30, height: 30), textColor: UIColor.red))
        ...
        let tabBarList = [agendaVC, speakersVC, helpVC]
