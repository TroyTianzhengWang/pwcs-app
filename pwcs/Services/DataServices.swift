...
//        return results
    ...
    private func readInRawSpeakers() {
        ...
        rawSpeakers.append(Speaker(name: "ChengRun Xie", title: "CEO of Lieping.com, North America Branch", desc: "For the past decade, low real interest rates, declining productivity growth, and lack of attractive domestic investment opportunities have forced global investors to seek higher returns in less familiar territories.", img: #imageLiteral(resourceName: "speaker_chengrun_xie"), panelType: .socialResponsibility))
    ...
    private func readInSchedule() {
        schedules = [0:[
            (TimelinePoint(), UIColor.black, "8:00AM - General Registration", "", nil, nil, "Sun"),
